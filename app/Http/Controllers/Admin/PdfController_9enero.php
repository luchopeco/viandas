...
class PdfController extends Controller
{
      ...
      public function planillasemanal()
    {
        ...
        $listClientes = Cliente::all()->sortBy("apellido");
...
//        return view('admin.pdf.planillasemanal',compact('listDiaSemana','listEmpresas','listClientesSinEmpresa'));
        return view('admin.pdf.planilla',compact('listDiaSemana','listEmpresas','listPedidos','cantidades','listClientes'));
    }

    public function planillasemanal_Anterior()
    {
        //set_time_limit(0);
        //ini_set("memory_limit",-1);
        //ini_set('max_execution_time', 0);
