                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        <div class=" box-body">
                                ...
                                @if($emp->dia_id = $d->id)
                                    <div class="row">
                                        <div class="callout callout-info">
                                            <h4>{{$emp->Empresa->nombre}} - {{$emp->ListPedidos->count()}} Pedidos</h4>
                                        </div>
                                        @foreach($emp->ListPedidos as $p)
                                            @if($p->ListLineasPedido->contains('dia_id',$d->id))
                                            @endif
                            ...
                            <div class="row">
                                <div class="callout callout-info">
                                    <h4>Clientes Sin Empresa - {{$listPedidosClientes->count()}} Pedidos </h4>
                                </div>
