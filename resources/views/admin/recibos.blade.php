   ...
   <div class="row">
       <div class=" col-md-12">
             <div class=" panel panel-default">
                   <div class=" panel-heading">Recibos a emitir -  SOLO clientes con envío
                   ...
                   <div class=" panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                   <button type="submit" id="btnBuscar" title="Buscar" class="btn btn-success "><i class="fa fa-search"></i></button>
                            </div>
                        </div>
                        <hr>
                         </form>
